<template>
  <q-page style="padding:0; margin:0;">
    <div class="q-pa-md row items-start q-gutter-md">
      <q-color v-model="rgba" inline class="my-picker" @input="changeColor" />
      <br>
      &nbsp;&nbsp;&nbsp;Window width: {{ ww }}<br>
      &nbsp;&nbsp;&nbsp;Window height: {{ wh }}
...
export default {
  ...
  methods: {
    changeColor: function(event) {
      this.$refs.div1.style.backgroundColor = this.rgba
      this.$refs.div5.style.backgroundColor = this.rgba
    },
  ...
  mounted() {
    ...
    // sve ovo treba napisati ponovno............
    let selected = null
